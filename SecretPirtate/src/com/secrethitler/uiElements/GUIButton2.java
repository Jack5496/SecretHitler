...
public class GUIButton2 extends Button {
	...
	public GUIButton2(String label, String buttonName, float xpos, float ypos, float scale) {
		this.text = label;
		this.xper = xpos;
		this.yper = ypos;
	...
	public GUIButton2 setOnHoverBigger(boolean bigger){
